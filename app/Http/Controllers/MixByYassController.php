...
class MixByYassController extends Controller
{
    private $client_id;
    ...
    public function payment($postedData)
    {
        try {
            ...
            $paymentDetails = [
                ...
                "redirectUri" => route('vender.tigo.redirect',['transactionRefId' => $transactionRefId]),
                "callbackUri" => route('vender.tigo.callback'),
                "language" => "eng",
                "terminalId" => "",
                "originPayment" => [
