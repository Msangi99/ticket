    ...
    <script>
        ...
        function calculateDistance() {
            ...
            <div class="grid grid-cols-2 gap-2 text-sm text-black">
                <div><span class="font-medium">{{ __('all.distance_label') }}</span> ${calculatedDistance} km</div>
                <div><span class="font-medium">{{ __('all.duration_label') }}</span> ${Math.floor(duration / 60)} min ${duration % 60} sec</div>
                <div><span class="font-medium">{{ __('all.start_label') }}</span> ${startLatLng.lat.toFixed(6)}, ${startLatLng.lng.toFixed(6)}</div>
                <div><span class="font-medium">{{ __('all.end_label') }}</span> ${endLatLng.lat.toFixed(6)}, ${endLatLng.lng.toFixed(6)}</div>
            </div>
        `;
