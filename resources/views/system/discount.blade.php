    ...
    <div class="container mx-auto px-4 py-6 max-w-4xl">
        ...
        <div class="bg-white rounded-lg shadow-md overflow-hidden">
            <div class="p-4 bg-gradient-to-r from-blue-500 to-blue-400 text-white flex justify-between items-center">
                <h2 class="text-lg font-semibold">Discounts</h2>
                    ...
                    <table id="discountsTable" class="w-full table-auto">
                        <thead>
                            <tr class="bg-gray-100 text-gray-600 uppercase text-xs leading-normal">
                                ...
                                <th class="py-2 px-4 text-left font-medium">Code</th>
                                <th class="py-2 px-4 text-left font-medium">%</th>
                                <th class="py-2 px-4 text-left font-medium">Used</th>
                            </tr>
                        </thead>
                        <tbody class="text-gray-600 text-xs">
                            ...
                            @empty
                                <tr>
                                    <td colspan="4" class="py-2 px-4 text-center text-gray-500">No discounts found</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
        ...
        <div id="addDiscountModal" class="hidden fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div class="bg-white rounded-lg shadow-lg w-full max-w-md mx-4 transform transition-all">
                <div class="p-4 flex justify-between items-center border-b border-gray-200">
                    <h2 class="text-lg font-semibold text-gray-800">Add Discount</h2>
                ...
                <form action="{{ route('system.add.coupon') }}" method="POST">
                    ...
                    <div class="p-4 space-y-3">
                        <div>
                            <label for="code" class="block text-xs font-medium text-gray-700 mb-1">Coupon Code</label>
                        ...
                        <div>
                            <label for="used" class="block text-xs font-medium text-gray-700 mb-1">Times Used</label>
                        ...
                        <div>
                            <label for="percentage" class="block text-xs font-medium text-gray-700 mb-1">Percentage</label>
                    ...
                    <div class="p-4 flex justify-end gap-2 border-t border-gray-200">
                        <button type="button" class="px-3 py-1 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition text-sm" onclick="document.getElementById('addDiscountModal').classList.add('hidden')">Close</button>
                        <button type="submit" class="px-3 py-1 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition text-sm">Save</button>
                    </div>
                </form>
            </div>
        </div>
