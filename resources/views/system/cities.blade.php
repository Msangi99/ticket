                ...
                <div class="overflow-x-auto">
                    <table id="citiesTable" class="w-full table-auto">
                        ...
                        <tbody class="text-gray-600 text-xs">
                            ...
                            @empty
                                <tr>
                                    <td colspan="2" class="py-2 px-4 text-center text-gray-500">No cities found</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
        ...
        <div id="addCityModal" class="hidden fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div class="bg-white rounded-lg shadow-lg w-full max-w-md mx-4 transform transition-all">
                <div class="p-4 flex justify-between items-center border-b border-gray-200">
                    <h2 class="text-lg font-semibold text-gray-800">Add New City</h2>
                ...
                <form action="{{ route('system.city.store') }}" method="POST">
                    ...
                    <div class="p-4 space-y-3">
                        <div>
                            <label for="cityName" class="block text-xs font-medium text-gray-700 mb-1">City Name</label>
                    ...
                    <div class="p-4 flex justify-end gap-2 border-t border-gray-200">
                        <button type="button" class="px-3 py-1 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition text-sm" onclick="document.getElementById('addCityModal').classList.add('hidden')">Close</button>
