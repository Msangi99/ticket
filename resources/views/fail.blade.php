            ...
            <div class="col-lg-8">
                ...
                <div class="card border-0 shadow-lg overflow-hidden animate__animated animate__fadeIn">
                    ...
                    <div class="bg-danger py-4 text-center">
                        <h2 class="text-white mb-0"><i class="fas fa-exclamation-triangle mr-2"></i> {{ __('all.payment_failed') }}</h2>
                    </div>
                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="py-5 px-4 text-center bg-white">
                            ...
                            <h3 class="text-dark mb-3 animate__animated animate__fadeInUp">{{ __('all.payment_unsuccessful') }}</h3>
                            <p class="text-muted animate__animated animate__fadeIn animate__delay-1s">{{ __('all.could_not_process_payment') }}</p>
                        </div>
                            ...
                            <div class="error-card p-4">
                                ...
                                <div class="alert alert-warning mt-4 animate__animated animate__fadeIn animate__delay-4s">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <h6 class="mb-1">{{ __('all.transaction_reference') }}</h6>
                        ...
                        <div class="p-4 bg-white text-center animate__animated animate__fadeIn animate__delay-5s">
                            <div class="d-flex flex-column flex-md-row justify-content-center">
                                <a href="#" onclick="window.history.back()" class="btn btn-danger btn-lg mb-3 mb-md-0 mr-md-3">
                                    <i class="fas fa-credit-card mr-2"></i> {{ __('all.retry_payment') }}
                                </a>
                                <a href="{{ url('/') }}" class="btn btn-outline-secondary btn-lg">
                                    <i class="fas fa-home mr-2"></i> {{ __('all.return_home') }}
                                </a>
                            </div>
                            
                            <div class="mt-4">
                                <p class="text-muted mb-2">{{ __('all.need_help') }}</p>
                                <a href="#" class="btn btn-link">
                                    <i class="fas fa-phone-alt mr-2"></i> {{ __('all.contact_support') }}
                                </a>
                            </div>
                        </div>
                    </div>
