...
<body>
    <div class="receipt-container">
        ...
        <div class="details">
            <p>Bus Operator: {{ $data->campany->name ?? 'N/A' }}</p>
            <p>Payment Number: {{ $data->campany->payment_number ?? 'N/A' }}</p>
            <p>Status: {{ $check[$data->campany->status] ?? 'Unknown' }}</p>
        </div>
        ...
        <div class="details">
            <table>
                ...
                @if ($data->vender_id)
                    <tr>
                        <td>Vendor Name:</td>
                        <td>{{ $data->vender->name ?? 'N/A' }}</td>
                    </tr>
                    <tr>
                        <td>Vendor Contact:</td>
                        <td>{{ $data->vender->contact ?? 'N/A' }}</td>
                    </tr>
                @endif
            </table>
        </div>
