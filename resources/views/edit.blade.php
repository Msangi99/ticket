        ...
        <div class="bg-white shadow-lg rounded-lg overflow-hidden">
            <div class="p-4 sm:p-6 border-b border-gray-200">
                <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                    <h1 class="text-xl font-bold text-gray-800">{{ __('customer/myticket.edit_booking') }}</h1>
                </div>
            </div>
            <div class="p-4 sm:p-6 w-6/12 justify-center">
                ...
                <form action="{{ route('booking.update') }}" method="post">
                    ...
                    <div class="mb-4">
                        <label for="name"
                            class="block text-gray-700 text-sm font-bold mb-2">{{ __('all.name_label') }}</label>
                    ...
                    <div class="mb-4">
                        <label for="email"
                            class="block text-gray-700 text-sm font-bold mb-2">{{ __('all.email_label') }}</label>
                     ...
                     <div class="mb-4">
                        <label for="email"
                            class="block text-gray-700 text-sm font-bold mb-2">{{ __('all.phone_label') }}</label>
